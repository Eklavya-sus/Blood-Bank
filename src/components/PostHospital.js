...
const NameTable = () => {
  return (
    <div className="container mx-auto px-4 sm:px-8">
      <div className="py-8">
        <div>
          <h2 className="text-3xl text-center mx-auto font-extrabold leading-tight text-[#02042b]">POST BLOOD BANK INFOMATION</h2>
                ...
                {NamesData.map((Name) => (
                  <tr key={Name.id}>
                    ...
                    <td className="px-10 py-5 border-b border-[#02042b] bg-white text-sm">
                      <p className="text-gray-900 whitespace-no-wrap">{Name.address}</p>
                    </td>
